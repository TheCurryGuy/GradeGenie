...
const Submissions = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setError(null)
      try {
        const response = await axios.get("https://grade-genie-server.vercel.app/api/v1/latest/assignments", {
          headers: {
            token: token,
          },
        })
    ...
    return (
      <div className="flex justify-center items-center h-screen bg-gray-50">
        <div className="relative w-16 h-16">
          <div className="absolute top-0 left-0 w-full h-full rounded-full border-4 border-t-indigo-600 border-r-indigo-200 border-b-indigo-400 border-l-indigo-100 animate-spin"></div>
    ...
    return (
      <div className="flex flex-col justify-center items-center h-screen bg-gray-50 p-4">
        <div className="bg-white rounded-xl shadow-md p-8 max-w-md w-full">
          ...
          <h2 className="text-2xl font-bold text-gray-800 text-center mb-3">Error</h2>
          <p className="text-gray-600 text-center mb-6">{error}</p>
          <button
            onClick={() => window.location.reload()}
            className="w-full py-3 px-4 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all duration-200 flex items-center justify-center"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            ...
            <p className="mt-2 text-gray-600 max-w-3xl">Manage and export your assignment submissions</p>
          </div>
          <div className="px-4 py-2 bg-indigo-50 text-indigo-700 rounded-full text-sm font-semibold flex items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        {combinedData.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-10 text-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-16 w-16 mx-auto text-gray-300 mb-6"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
                ...
                >
                  <div className="p-6">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                      <h2 className="text-xl font-bold text-gray-800">{item.submission.Title}</h2>
                      <div
                    ...
                    <div className="bg-gray-50 border border-gray-100 rounded-lg mb-4 relative pl-4">
                  ...
                  <div className="bg-gray-50 px-6 py-4 flex flex-wrap md:flex-nowrap items-center justify-between border-t border-gray-100">
                    <div className="flex flex-wrap items-center gap-6 mb-3 md:mb-0">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <div
                            className={`text-sm font-medium ${deadlinePassed ? "text-red-600" : deadlineApproaching ? "text-amber-700" : "text-gray-700"}`}
                          >
