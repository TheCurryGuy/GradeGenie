        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <motion.button
                        className="group relative z-10 bg-white text-blue-700 text-lg font-semibold rounded-xl px-8 py-4 shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50 transition-all duration-300"
